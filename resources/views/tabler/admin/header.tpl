                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
                            <ul class="navbar-nav">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-menu-columns">
                                            <div class="dropdown-menu-column">
                                                ...
                                                <a class="dropdown-item" href="/admin/addon">
                                ...
                                {foreach from=$addon_admin_header_items item=v}
                                    {if $v.type == "dropdown"}
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle" href="#navbar-layout" data-bs-toggle="dropdown"
                                                data-bs-auto-close="outside" role="button" aria-expanded="false">
                                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                                    <i class="ti ti-{$v.icon} icon"></i>
                                                </span>
                                                <span class="nav-link-title">
                                                    {$v.name}
                                                </span>
                                            ...
                                            <div class="dropdown-menu">
                                                <div class="dropdown-menu-columns">
                                                    <div class="dropdown-menu-column">
                                                        {foreach from=$v.children item=$child}
                                                            {if $child.type=="dropdown"}
                                                                <div class="dropend">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        {foreach from=$child.children item=$nestedchild}
                                                                            <a href="{$nestedchild.href}" class="dropdown-item">
                                                                                <i class="ti ti-{$nestedchild.icon}"></i>&nbsp;
                                                                                {$nestedchild.name}
                                                                            </a>
                                                                        {/foreach}
                                                                    </div>
