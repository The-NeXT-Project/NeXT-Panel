...
final class ImController extends BaseController
{
    private static array $update_field = [
        ...
        'telegram_add_detect_rule',
        'telegram_add_detect_rule_text',
        'telegram_purchase_notify',
        'telegram_purchase_notify_text',
        'telegram_ticket_notify',
        'telegram_ticket_notify_text',
